...
function ElementosGrupoCadeia({ cartaSelecionada, handleClick, ordernarPorNivel, grupo }) {
    const { dados, carregando } = useFetchElementos(grupo={grupo});
...
export default ElementosGrupoCadeia;
