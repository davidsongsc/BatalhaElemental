...
orgg = "agua"
aguaUm_01 = Personagem(nome="Barbara Aqua", origem=orgg, classe="Guerreiro", tipo_magia="", habilidades=[ATAQUE1, ATAQUE2,ATAQUE3, ATAQUE4, ATAQUE5, ATAQUE6, ATAQUE7, ATAQUE8])
...
orgg = "vento"
ventoUm_01 = Personagem(nome="Jessica Zephyr", origem=orgg, classe="Feiticeiro", tipo_magia="", habilidades=[ATAQUE1, ATAQUE2,ATAQUE3, ATAQUE4, ATAQUE5, ATAQUE6, ATAQUE7, ATAQUE8])
